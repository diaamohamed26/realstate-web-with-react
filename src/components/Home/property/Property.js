...
const Property = () => {
    return(
        <div className='property'>
            ...
            <p className='property-p'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                <br></br> Ut enim ad minim veniam.</p>
